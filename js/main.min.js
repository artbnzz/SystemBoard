jQuery(document).ready(function(e) {
    ...
    /*function d() {
        clearTimeout(D), X = 0, e(window).scrollTop() < j[4] && TweenMax.to(window, .5 + Math.abs(e(window).scrollTop() / C - Math.round(e(window).scrollTop() / C)), {
            scrollTo: {
                y: Math.round(e(window).scrollTop() / C) * C
            },
            ease: Quad.easeInOut
        }), e(window).scrollTop() > j[4] - C / 2 && e(window).scrollTop() < j[5] + C / 2 && TweenMax.to(window, .5 + Math.abs(e(window).scrollTop() / C - Math.round(e(window).scrollTop() / C)), {
            scrollTo: {
                y: j[5] + Math.round((e(window).scrollTop() - j[5]) / C) * C
            },
            ease: Quad.easeInOut
    ...
    function T(a, o) {
        ...
        for (var n = 0; n < P[t].plates.length; n++) {
            ...
            s.attr("id", P[t].plates[n].title), s.removeClass("hidden"), s.find(".blocLeft h5").html(P[t].plates[n].title), s.find(".blocLeft").append(P[t].plates[n].description), s.find(".blocRight").append(P[t].plates[n].price + "โฌ"), s.appendTo(".listing ul")
        }
    ...
    e(window).bind("mousewheel DOMMouseScroll wheel MozMousePixelScroll", function(a) {
        if ("visible" == e(".carte").css("visibility") && (a.preventDefault(), a.stopPropagation()), e(window).scrollTop() < j[2]) a.preventDefault(), a.stopPropagation(), Q = q.check(a), Q !== !1 && Q != X && (X = Q, TweenMax.to(window, 1.2, {
            scrollTo: {
